...
document.addEventListener("click", function (e) {
  ...
  if (elementInteractive.closest(".hike__image-play")) {
    const hikeVideo = elementInteractive.closest(".hike__image").querySelector("video");
    const hikePlay = elementInteractive.closest(".hike__image").querySelector(".hike__image-play");

    if (hikeVideo) {
      hikeVideo.setAttribute("controls", "controls");
      hikeVideo.play();
      hikePlay.remove();
    }
  }
